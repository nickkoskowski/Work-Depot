...
<header class="side-menu left <?php echo esc_attr($large_side_header) ; ?> mango_header20">
<!-- side-menu-wrapper -->
    <div class="<?php echo ($large_side_header)?"side-menu-container":"side-menu-container" ?>">
        <h1 class="logo">
