...
if(isset($post)){
    $id = $post->ID;
    $mango_hide_footer = get_post_meta ( $id, 'mango_top_footer_widget_hide', true ) ? get_post_meta ( $id, 'mango_top_footer_widget_hide', true ) : '';
...
$mango_top_footer_v2 = get_post_meta ( $id, 'mango_top_footer_widget_v2_columns', true ) ? get_post_meta ( $id, 'mango_top_footer_widget_v2_columns', true ) : '';
