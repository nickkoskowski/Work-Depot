...
<table class="table table-responsive shop_table order_details">
	<thead>
		<tr>
...
<table class="shop_table table table-responsive shop_table_responsive customer_details">
<?php
...
<div class="col2-set row addresses">
		...
		<address>
			<?php
				if ( ! $order->get_formatted_billing_address() ) {
					...
					echo strip_tags(str_replace("<"," <",$order->get_formatted_billing_address()));
				}
			?>
		</address>
		...
		<address>
			<?php
				if ( ! $order->get_formatted_shipping_address() ) {
					...
					echo strip_tags(str_replace("<"," <",$order->get_formatted_shipping_address()));
				}
			?>
		</address>
	</div><!-- /.col-2 -->
