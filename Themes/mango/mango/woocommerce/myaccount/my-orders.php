...
if ( $customer_orders ) : ?>
	...
	<table class="shop_table table table-responsive shop_table_responsive my_account_orders">
		<thead>
			<tr>
						...
						<?php
							...
							if ( $actions ) {
								foreach ( $actions as $key => $action ) {
									echo '<a href="' . esc_url( $action['url'] ) . '" class="button ' . sanitize_html_class( $key ) . '"><strong>' . esc_html( $action['name'] ) . '</strong></a>';
								}
							}
						?>
					</td>
