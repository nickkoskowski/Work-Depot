                            ...
                            <?php if( $show_stock_status ) : ?>
                                <td class="product-stock-status">
                                    ...
                                    if( $stock_status == 'out-of-stock' ) {
                                        $stock_status = "Out";
                                        echo '<h5><span class="wishlist-out-of-stock">' . __( 'Out of Stock', 'yit' ) . '</span></h5>';
                                    } else {
                                        $stock_status = "In";
                                        echo '<h5><span class="wishlist-in-stock">' . __( 'In Stock', 'yit' ) . '</span></h5>';
                                    }
                                    ?>
                                </td>
                            <?php endif ?>
...
<!--                                            change-wishlist selectBox-->
                            ...
                            <?php if( $is_user_owner ): ?>
                                <td class="product-remove">
                                    <a href="<?php echo esc_url( add_query_arg( 'remove_from_wishlist', $item['prod_id'] ) ) ?>" class="remove btn btn-custom btn-sm btn-close remove_from_wishlist" title="<?php _e( 'Remove this product', 'yit' ) ?>"><i class="fa fa-times"></i></a>
                                </td>
                            <?php endif; ?>
                ...
                <td colspan="<?php echo esc_attr( $column_count ) ?>">
                    <?php if( $show_cb ) : ?>
                        <div class="custom-add-to-cart-button-cotaniner">
                            <a href="<?php echo esc_url( add_query_arg( array( 'wishlist_products_to_add_to_cart' => '', 'wishlist_token' => $wishlist_meta['wishlist_token'] ) ) ) ?>" class="button alt btn btn-custom min-width" id="custom_add_to_cart"><?php _e( 'Add the selected products to the cart', 'yit' ) ?></a>
                        </div>
                    <?php endif; ?>
