...
<form class="cart" method="post" enctype='multipart/form-data'>
	<table cellspacing="0" class="group_table table table-responsive borderless">
		<tbody>
			<?php
					...
					<tr>
						<td>
							<?php if ( $product->is_sold_individually() || ! $product->is_purchasable() ) : ?>
								<?php mango_add_to_cart($product_id); ?>
							<?php else : ?>
								<?php
						...
						<td class="label margin_top_20">
							<label class="input-desc" for="product-<?php echo $product_id; ?>">
						...
						<td class="price product-price-container">
							<?php
