...
class IconizeWidgetTaxonomies extends WP_Widget {
	...
	function __construct() {
  parent::__construct(
   'IconizeWidgetTaxonomies', 
   __( 'Iconized Taxonomies', 'iconize' ),
   array ( 'classname' => 'iconize_widget_taxonomies', 'description' => __( 'Display iconized taxonomy terms ( Categories, Tags, custom taxonomies )', 'iconize') )
  );
 }
